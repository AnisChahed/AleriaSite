							...
							<div class="container mainnav">
								...
								<div class="collapse navbar-collapse navbar-collapse">
									...
									<ul class="nav navbar-nav navbar-right">
										...
										<!-- Expertises -->
										<li><a href="expertise.php">Expertises</a></li>
										<!-- /Expertises -->
									...
									<div class="contact-map">
										...
										<form id="mainContact" action="mail.php" method="POST">
											...
											<div class="form-group text-area">
												...
												<textarea name="msg" class="form-control" rows="6" required="" placeholder=""></textarea>
											</div>
			        			...
			        			<div class="col-md-3 col-sm-4">
			        				<div class="footer-widget">
			        					...
			        					<ul>
                                            ...
                                            <li><a href="expertise.php">Service</a></li>
                                            <li><a href="our-people.html">Our people</a></li>
                                            <li><a href="career.html">Career</a></li>
                                            <li><a href="support.php">FAQ Page</a></li>
                                        </ul>
			        				</div><!-- /.footer-widget -->
			        			</div><!-- /.col-md-4 -->
